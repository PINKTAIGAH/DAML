...
RunAction::RunAction() : G4UserRunAction()
{
  ...
  analysisManager->CreateH1( "Target", "Target deposited energy", 100, 0.0, 500.0*MeV ); // histogram id 1
  ...
  // Add an ntuple for Target energy deposits
  analysisManager->CreateNtuple( "Target", "Target deposited energy" ); // ntuple id 1
  analysisManager->CreateNtupleDColumn( "Target" ); // column id 1
